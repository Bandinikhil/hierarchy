...
//           <input type="text" value={teamLeaderName} onChange={(e) => setTeamLeaderName(e.target.value)} required />
//         </div>
//         <div>
//           <label>Team Leader Phone:</label>
//           <input type="text" value={teamLeaderPhone} onChange={(e) => setTeamLeaderPhone(e.target.value)} required />
//         </div>
//         <div>
//           <label>Team Leader Email:</label>
//           <input type="email" value={teamLeaderEmail} onChange={(e) => setTeamLeaderEmail(e.target.value)} required />
//         </div>
//         <button type="submit" disabled={error}>{team ? 'Update Team' : 'Add Team'}</button>
//       </form>
...
//     const isDuplicateName = teams.some(t => t.id !== team?.id && t.name === teamName);
//     if (isDuplicateName) {
//       alert('Team names cannot be identical!');
//       return;
//     }
...
//               <div className="mb-4">
//                 <label htmlFor="teamName" className="block text-sm font-medium text-gray-700">Team Name:</label>
//                 <input type="text" id="teamName" value={teamName} onChange={(e) => setTeamName(e.target.value)} className="mt-1 p-2 block w-full rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required />
//               </div>
//               <div className="mb-4">
//                 <label htmlFor="teamLeaderName" className="block text-sm font-medium text-gray-700">Team Leader Name:</label>
//                 <input type="text" id="teamLeaderName" value={teamLeaderName} onChange={(e) => setTeamLeaderName(e.target.value)} className="mt-1 p-2 block w-full rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required />
//               </div>
//               <div className="mb-4">
//                 <label htmlFor="teamLeaderPhone" className="block text-sm font-medium text-gray-700">Team Leader Phone:</label>
//                 <input type="text" id="teamLeaderPhone" value={teamLeaderPhone} onChange={(e) => setTeamLeaderPhone(e.target.value)} className="mt-1 p-2 block w-full rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required />
//               </div>
//               <div className="mb-4">
//                 <label htmlFor="teamLeaderEmail" className="block text-sm font-medium text-gray-700">Team Leader Email:</label>
//                 <input type="email" id="teamLeaderEmail" value={teamLeaderEmail} onChange={(e) => setTeamLeaderEmail(e.target.value)} className="mt-1 p-2 block w-full rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required />
//               </div>
//               <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
//                 <button type="submit" className="w-full inline-flex justify-center rounded-r-full rounded-l-full border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:ml-3 sm:w-auto sm:text-sm">
//                   {team ? 'Update Team' : 'Add Team'}
//                 </button>
