...
const MoveTeamMemberForm = ({ departmentId, currentTeamId, teamMemberId, onClose }) => {
  ...
  const handleMoveTeamMember = (e) => {
    e.preventDefault();
    dispatch(moveTeamMember({ departmentId, currentTeamId, newTeamId, teamMemberId }));
    onClose();
  };
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50">
      <div className="bg-white p-4 w-[80%] md:w-1/2 lg:w-1/3 rounded shadow-md">
        ...
        <form onSubmit={handleMoveTeamMember}>
          <div className="mb-2">
            <label className="block text-sm font-medium" htmlFor="team">Select New Team</label>
            <select
              id="team"
